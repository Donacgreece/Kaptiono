...
function goSupport(){showPage('support')}
...
window.addEventListener('appinstalled',()=>{deferredInstallPrompt=null;hideInstallBanner();localStorage.setItem('kaptiono-installed','1')});
