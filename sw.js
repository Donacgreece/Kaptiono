const CACHE='kaptiono-web-v0.4.1';
const SHELL=['./','./index.html','./styles.css?v=0.4.1','./app.js?v=0.4.1','./manifest.webmanifest','./assets/icons/icon-64.png','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
