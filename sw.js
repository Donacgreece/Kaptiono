const CACHE='kaptiono-web-lab-0.2.0';
const SHELL=['./','./index.html','./styles.css?v=0.2.0','./app.js?v=0.2.0','./manifest.webmanifest','./assets/icons/icon-64.png','./assets/icons/icon-192.png','./assets/icons/icon-512.png'];
