const CACHE='kaptiono-web-v0.5.18';
const SHELL=[
  './','./index.html','./styles.css?v=0.5.18','./app.js?v=0.5.18','./whisper-worker.js?v=0.5.18','./manifest.webmanifest',
...
self.addEventListener('activate',event=>{
  event.waitUntil((async()=>{
    ...
    clients.forEach(client=>client.postMessage({type:'KAPTIONO_UPDATE_READY',version:'0.5.18'}));
  })());
});
