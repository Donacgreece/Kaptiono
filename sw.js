...
const SHELL=[
  './','./index.html','./styles.css?v=1.0.0','./app.js?v=1.0.0','./consent.js?v=1.0.0','./legal.js?v=1.0.0','./whisper-worker.js?v=1.0.0','./manifest.webmanifest','./about/','./about/index.html','./about/about.css?v=1.0.0','./about/about.js?v=1.0.0',
